...
=======
    ...
    private List<Enemigo> crearEnemigos(Dificultad dificultad) {
        ...
        if (dificultad == Dificultad.FACIL) {
            // En fácil, quitar la mayoría de los enemigos (excepto el jefe)
            // Usamos mayor probabilidad de eliminación para hacer el nivel más liviano
            enemigos.removeIf(e -> !e.getNombre().equals("REY MAGO") && random.nextDouble() < 0.75);
